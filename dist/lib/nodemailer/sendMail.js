...
var emailAddressFrom = "meiskenmailservice@gmail.com";
var sendMail = function (_a) {
    var email = _a.email, token = _a.token, _b = _a.temple, temple = _b === void 0 ? "confirm" : _b;
    return __awaiter(void 0, void 0, void 0, function () {
        var transporter, url, mailOptions;
        return __generator(this, function (_c) {
            ...
            url = process.env.BASE_URL + "/user/" + temple + "/" + token;
            mailOptions = {};
            if (temple === "confirm") {
                mailOptions = {
