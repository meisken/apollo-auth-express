...
var forgotPassword = function (_, _a) {
    var email = _a.email;
    return __awaiter(void 0, void 0, void 0, function () {
        var user, token, sendMailResult, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, setToken_1.setForgotPasswordToken({ userId: user.id, expiresIn: 60 * 10 })];
                case 2:
                    token = _b.sent();
                    return [4 /*yield*/, sendMail_1.sendMail({ email: email, token: token, temple: "forgot-password" })];
                case 3:
