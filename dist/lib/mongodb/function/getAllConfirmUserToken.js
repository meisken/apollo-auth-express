    ...
    var promise = new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, Token_1.UserToken.find({ type: setToken_1.tokenPrefix.confirmation })];
                case 1:
                    result = _a.sent();
                    if (!result) {
...
exports.getAllConfirmUserToken = getAllConfirmUserToken;
