    ...
    var promise = new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 8]);
                    return [4 /*yield*/, Token_1.UserToken.findOne({ uid: uid, type: setToken_1.tokenPrefix.access, ip: inComingIp })];
                case 2:
                    parsedToken = _a.sent();
                ...
                case 3:
                    ...
                    return [4 /*yield*/, User_1.User.findById(parsedToken.userId)];
                case 4:
                    user = _a.sent();
                    if (user) {
